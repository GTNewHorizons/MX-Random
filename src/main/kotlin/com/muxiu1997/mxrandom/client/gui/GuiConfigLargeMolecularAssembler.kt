    ...
    val LANG_CRAFTING_FX: String
      get() =
          StatCollector.translateToLocal(
              "$MODID.client.gui.GuiConfigLargeMolecularAssembler.craftingFX")
    val LANG_HIDDEN: String
      get() =
          StatCollector.translateToLocal(
              "$MODID.client.gui.GuiConfigLargeMolecularAssembler.hidden")
    val LANG_VISIBLE: String
      get() =
          StatCollector.translateToLocal(
              "$MODID.client.gui.GuiConfigLargeMolecularAssembler.visible")
  }
}
