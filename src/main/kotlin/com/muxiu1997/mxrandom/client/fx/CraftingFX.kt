...
class CraftingFX(w: World, x: Double, y: Double, z: Double, age: Int, itemStack: IAEItemStack) :
    EntityFX(w, x, y, z, 0.0, 0.0, 0.0) {
  private val entityItem =
      EntityItem(worldObj, 0.0, 0.0, 0.0, itemStack.itemStack).also { it.hoverStart = 0.0f }
  ...
  override fun getBrightnessForRender(partialTickTime: Float): Int =
      15.let { (it shl 20) or (it shl 4) }
